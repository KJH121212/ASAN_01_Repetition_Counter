...
DOCKER_CONTAINER_NAME="kimjihoo_yolo_jupyter"
DOCKERFILE_PATH="/mnt/nas203/ds_RehabilitationMedicineData/IDs/Kimjihoo/ASAN_01_Repeatition_Counter/docker/Dockerfile.yolo"
